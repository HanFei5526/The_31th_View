...
const CARDS = {
  ...
  history: {
    title: '古画秘史',
    items: [
      { name: '文徵明', desc: '明代吴门四家之一，拙政园三十一景图的绘制者。', tag: '画者' },
      { name: '王蘅', desc: '被历史遗忘的女画者，在笔墨间留下了第三十一景。', tag: '秘影' },
      { name: '拙政园', desc: '始建于明正德年间，几经易主，园中一草一木皆是见证。', tag: '园史' },
      { name: '三十一景', desc: '文徵明所绘三十景之外，第三十一景暗藏于画纸底层。', tag: '画谜' },
      { name: '断簪', desc: '一根刻有"蘅"字的断簪，是王蘅留在画中的唯一信物。', tag: '信物' },
      { name: '残砚', desc: '一方残破的砚台，砚底小字虽已模糊，朱砂底线犹在。', tag: '信物' },
    ],
  },
  figures: {
    title: '人物图鉴',
    items: [
      ...
      { name: '王蘅', desc: '明代女画者，才华横溢却不见于正史。她的痕迹散落在画中各处。', tag: '核心' },
      { name: '王献臣', desc: '拙政园第一任园主，园中匾额多出其手笔。', tag: '园主' },
      { name: '徐氏', desc: '拙政园女主人，园中"卅六鸳鸯馆"为其所题。', tag: '女史' },
      { name: '后人', desc: '五百年来，无数人在画中看过、路过，却无人留意她的痕迹。', tag: '过客' },
    ],
  },
};
...
export default class LandingScene {
  ...
  _buildDOM() {
        ...
        <main class="landing-main">
          <div class="landing-left">
            ...
            <p class="landing-desc">
              ...
              你发现画中有画——一位被历史遗忘的女画者王蘅，在笔墨之间留下了第三十一景的线索。
              从修复工作室到明代园林，从断簪到残砚，一步步解开隐藏了五个世纪的秘密。
            </p>
    ...
    root.querySelector('#btn-enter').addEventListener('click', () => {
      ...
      const lines = [
        "你是一位古画修复师的学生。",
        "在修复文徵明《拙政园三十一景图》的过程中，你发现画中有画——",
        "一位被历史遗忘的女画者王蘅，在笔墨之间留下了第三十一景的线索。",
        "从修复工作室到明代园林，从断簪到残砚，一步步解开隐藏了五个世纪的秘密。"
      ];
