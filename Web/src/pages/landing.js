        ...
        <main class="landing-main">
          <div class="landing-left">
            ...
            <p class="landing-desc">
              你叫沈念，是一名古画修复专业的研究生，在为《拙政园三十一景图》最后一页做数字化归档时，发现放大的扫描件装裱层下有细微的异常痕迹。一页五百年来鲜有人怀疑的画，一段被规范无声覆盖的过往，一层完好得不像经历过五百年的装裱。修复课上学过的那句话浮上来——太完整，反而可疑。现实工作室的修复检测，画中园林的追踪探索，修复笔记本上的记录推理——表象之下，这页画还在沉默地讲述着什么？
            </p>
          </div>
        </main>
