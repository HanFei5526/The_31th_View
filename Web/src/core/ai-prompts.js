...
export function buildGateZhouPrompt(ctx, gateId, systemHint = '') {
  ...
  switch (gateId) {
    ...
    case 'gate_prologue_text':
      ...
      forbiddenInsight = '不要说是署名，也不要说是后人修补的。不要直接说出"观看视点""规定观者位置""记录谁看过"等结论性解释——"所见"的含义留给玩家自己推断。不要把残字与其他线索联系成整体结论。一次只讨论这处残字本身。';
      break;
    ...
    case 'gate_prologue_synthesis':
      ...
      allowedInsight = '可以比较旧题签残角、"所见"残字、底层细线三者的位置共同点：边缘、装裱层、画面下方、画面主体之外。可以追问这些痕迹原本是否在说明这页画的来历，也可以追问它们是自然坏掉还是被后来的装裱整理压住。';
      forbiddenInsight = '不要说出"王蘅"，不要说"某位女性""她""被遮蔽的观看者"。不要透露画中世界、芙蓉榭、栏杆下、低处观看、三景同入一眼。不要说文徵明采用了别人的视角、草图或构图。不要说这些痕迹是谁留下的。不要编造馆藏记录、来源编号、数据库条目、历史档案或鉴定结论。不要说第三十一景不是文徵明画的、多人执笔、失踪画作、重画替换。玩家未明确表达前，不要直接断言"后来处理留下的痕迹""人为遮蔽""来源信息被遮蔽"。不要在玩家通过前直接说出"有人系统性地遮蔽了这幅画的来源信息"或等价完整结论。';
      discussionScopeRule = '可以比较旧题签、残字、底层细线三处线索，但只能引导玩家观察位置和处理方式，不能替玩家说出最终结论。';
      languageRule = '白话优先，每次 1-2 句，尽量不超过 90 字。每次至少点回旧题签、残字、底层细线中的一处。先说看见了什么，再说它可能说明什么。少用"画心""题跋""体例""说明性材料"等术语；必须使用时，先用"画本身""边上的字""整套册页统一格式""说明这页画来历的小痕迹"这类白话解释。不要使用当前记录没有明确支持的材料层级或专业判断，例如"托纸""夹层""画背""装裱次序""受潮""磨损""装裱过渡区域"。';
      break;
    default:
