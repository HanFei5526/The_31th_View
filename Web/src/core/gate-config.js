...
export const GATE_CONFIG = {
  ...
  gate_prologue_margin: {
    ...
    hintPool: [
      '如果画心没问题，为什么要动装裱？除非……装裱下面藏着什么。',
      '后人在重装时，往往为了统一全册体例，而裁切或遮盖边缘不规整的部分。',
      `关键不是'有没有处理过'，而是'为什么处理'。被遮盖的是无用残损，还是有人不想让人看到的痕迹？`,
    ],
    ...
    // 离线模式纠正回复池（玩家说反了或偏离时）
    correctionPool: [
      '画心本身没有问题。问题在边缘的处理方式上。',
      '你再想想。正常的老化不会留下这种规则的压痕。这不是时间问题，是人的问题。',
      '不要急着下结论。先看证据：接缝、压痕、遮盖——这三件事连在一起，说明什么？',
    ],
    // 快捷想法按钮（降低输入门槛）
    quickThoughts: [
      '边缘是不是被什么东西遮住了？',
  ...
  gate_prologue_text: {
    ...
    hintPool: [
      '古画的边注通常记录创作信息——谁画的、画的是什么、从哪里看的。',
      '如果是正式题跋，不会藏在这种位置。这更像是某种标注——后人觉得不需要保留的标注。',
      `'所见'——谁所见？看见什么？这两个字本身就在问问题。`,
    ],
    affirmPool: [
      '对。',
      '嗯，继续。',
    ...
    correctionPool: [
      '文徵明的署名不会这么不规整，也不会藏在这里。',
      '后人如果修补，只会遮盖，不会写半句没头没尾的话。',
      `再想想'所见'两个字——这是关于'看'的记录。`,
    ],
    quickThoughts: [
      '这是被裁掉的题记残片吗？',
      '"所见"是不是和观看视角有关？',
  ...
  gate_prologue_line: {
    ...
    hintPool: [
      '先看它和裂纹、折痕有什么不同。',
      '如果它不是画面内容，为什么会被留在画面下方？',
      '它暂时不是答案，但它能证明这里有一层正式记录没有解释的东西。',
    ],
    affirmPool: [
      '嗯。',
      '你注意到它不像普通损伤。',
    ...
    correctionPool: [
      '现在不要直接把它解释成某个结论。先记录它和其他痕迹之间的关系。',
      '重点不是它好不好看，而是它为什么没有出现在正式记录里。',
      '如果一处细线也被忽略，可能说明被忽略的不只是文字。',
    ],
    quickThoughts: [
      '这条线不像裂纹吧？',
      '它是不是被压住的底层痕迹？',
  ...
  gate_prologue_synthesis: {
    ...
    hintPool: [
      "先别把三处痕迹分开看。旧题签、残字、底层细线，都指向同一个问题：有人不想让后来者知道什么？",
      "如果只是保存不善，痕迹会散乱；但这三处都和说明来源有关。你再把它们连起来。",
      "题签、边注和底层细线都不是画面装饰。它们原本都可能在说明这幅画的来源。",
    ],
    affirmPool: [
      "方向对。继续把'谁不想让人看见'和'不想让人看见什么'说清楚。",
      "嗯，你已经把它们连起来了，再往来源信息上想一步。",
      "对，不像自然损坏。还要说明它被处理掉的对象是什么。",
    ],
    correctionPool: [
      "不是画心失踪，也不是新画替换。画还在，消失的是解释这幅画来源的东西。",
      "不要急着找一个具体姓名。现在证据只能说明：有人处理过来源痕迹。",
      "如果三处痕迹都被动过，问题就不只是单个破损，而是一组被整理过的证据。",
    ],
    quickThoughts: [
      '三处痕迹都被处理过，是巧合吗？',
      '被遮蔽的会不会是来源信息？',
